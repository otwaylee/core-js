...
console.log(authUser['email']); // getter
...
// 객체의 key 만을 모아놓은 배열을 반환하는 메서드 Object.keys()
...
// const first = document.querySelector('.first') 이렇게 할 수도 있지만 위에가 동일한 결과 도출
